...
exports.standardAmenities = void 0;
exports.getDefaultAmenities = getDefaultAmenities;
exports.getRelevantAmenities = getRelevantAmenities;
/**
 * Predefined list of possible amenities for different place types
 */
exports.standardAmenities = [
    // Facilities
    {
        id: 'parking',
        name: 'Parking',
 ...
 */
function getDefaultAmenities(detailType) {
    return exports.standardAmenities.filter(amenity => amenity.defaultFor.includes(detailType));
}
/**
 * Helper function to get relevant amenities for a place type
 */
function getRelevantAmenities(placeType) {
    return exports.standardAmenities.filter(amenity => amenity.relevantTo.includes(placeType));
}
